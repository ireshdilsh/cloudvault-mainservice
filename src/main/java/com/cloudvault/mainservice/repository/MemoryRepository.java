...
public interface MemoryRepository extends JpaRepository<Memory, UUID> {
    ...
    Page<Memory> findVisible(Long userId, String search, LocalDate from, LocalDate to, String place, com.cloudvault.mainservice.entity.MemoryCategory category, Pageable pageable);
    ...
    @Modifying @Query("update Memory m set m.deletedAt = CURRENT_TIMESTAMP where m.userId = :userId and m.deletedAt is null")
