...
@Getter @Setter @Entity @Table(name = "memory_photo", indexes = @Index(name = "idx_photo_memory", columnList = "memory_id"))
public class MemoryPhoto {
    @Id @GeneratedValue(strategy = GenerationType.UUID) private UUID id;
    @Column(name = "memory_id", nullable = false) private UUID memoryId;
    @Column(nullable = false, length = 512) private String storageKey;
